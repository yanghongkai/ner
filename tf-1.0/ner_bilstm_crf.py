...
tf.app.flags.DEFINE_string('train_data_path',"train/",'Training data dir')
tf.app.flags.DEFINE_string('valid_data_path',"dev_ids_80.txt",'valid data dir')
tf.app.flags.DEFINE_string('test_data_path',"rmrb_ner_ids_80.txt",'Test data dir')
tf.app.flags.DEFINE_string('log_data',"log_data",'log data dir')
tf.app.flags.DEFINE_string('log_dir',"logs",'The log dir')
tf.app.flags.DEFINE_string('word2vec_path',"word_vectrain_50.txt",'the word2vec data path')
tf.app.flags.DEFINE_integer('max_sentence_len',80,'max num of tokens per query')
tf.app.flags.DEFINE_integer('embedding_size',50,"embedding size")
tf.app.flags.DEFINE_integer('num_tags',13,'0-12')
...
def test_evaluate(sess, inference_op, length_op, transMatrix, inpx, tX, tY, desc, out,step, learning_rate):
    ...
    out.write("%d\t%.4f\t%.3f\t%.1f\n" % (step,learning_rate,accuracy,span))
...
def main(unused_argv):
    ...
    _,filenames=getFilenamePath(trainDataPath)
    print(filenames)
    graph=tf.Graph()
