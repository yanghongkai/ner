...
tf.app.flags.DEFINE_string('word2vec_path',"./char_vec_50.txt",'the word2vec data path')
...
class Model:
    ...
    def loss(self,X,Y):
        ...
        cross_entropy=tf.nn.sparse_softmax_cross_entropy_with_logits(labels=Y,logits=logits_)
